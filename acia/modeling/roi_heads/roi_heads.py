...
from acia.modeling.roi_heads.fast_rcnn import FastRCNNFocaltLossOutputLayers, FastRCNNAdaFocaltLossOutputLayers
...
class StandardROIHeadsPseudoLab(StandardROIHeads):
    ...
    def _init_box_head(cls, cfg, input_shape):
        ...
        elif cfg.MODEL.ROI_HEADS.LOSS == "AdaFocalLoss":
            box_predictor = FastRCNNAdaFocaltLossOutputLayers(cfg, box_head.output_shape)
        else:
    ...
    def forward(
        ...
        if (branch.startswith("instance_level_align")):
    ...
    def label_and_sample_proposals(
        ...
        if (self.proposal_append_gt and not (branch.startswith("instance_level_align"))):
